...
<div class="col-sm-12 form-group"> 
    ...
    -->
			...
			<textarea  rows="2" class="form-control" readonly><?php echo $prerequisite?></textarea>
			</div>
			
			<div class="form-group">
			<label for="lecture">No. of Lecture :</label>
            
			<input  type="text" name="lecture" value="<?php echo $lecture?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="tutorial">No. of Tutorial :</label>
            
			<input  type="text" name="tutorial" value="<?php echo $tutorial?>"  class="form-control" readonly >
			</div>
			...
			<input  type="text" name="practical" value="<?php echo $practical?>"  class="form-control" readonly >
			</div>	
		
			
			<div class="form-group">
			<label for="prerequisite">Unit 1</label>
			<textarea  class="form-control" readonly><?php echo $unit1?></textarea>
			</div>
			
			
			<div class="form-group">
			<label for="prerequisite">Unit 2</label>
			<textarea  class="form-control" readonly><?php echo $unit2?></textarea>
			</div>
			
			
			<div class="form-group">
			<label for="prerequisite">Unit 3</label>
			<textarea  class="form-control" readonly><?php echo $unit3?></textarea>
			</div>
			
			
			
			<div class="form-group">
			<label for="prerequisite">Unit 4</label>
			<textarea  class="form-control" readonly><?php echo $unit4?></textarea>
			</div>
			
			<div class="form-group">
			<label for="prerequisite">Unit 5</label>
			<textarea  class="form-control" readonly><?php echo $unit5?></textarea>
			</div>
			
			
			<div class="form-group">
			<label for="text1">Text Book 1 :</label>
            <input  type="text" name="text1" value="<?php echo $text1?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="text2">Text Book 2 :</label>
            <input  type="text" name="text2" value="<?php echo $text2?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="text3">Text Book 3 :</label>
            <input  type="text" name="text3" value="<?php echo $text3?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="ref1">Reference Book 1 :</label>
            <input  type="text" name="ref1" value="<?php echo $ref1?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="ref2">Reference Book 2 :</label>
            <input  type="text" name="ref2" value="<?php echo $ref2?>"  class="form-control" readonly >
			</div>
			
			<div class="form-group">
			<label for="ref3">Reference Book 3 :</label>
            <input  type="text" name="ref3" value="<?php echo $ref3?>"  class="form-control" readonly >
			</div>
