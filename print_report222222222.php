...
//foreach($your_data_array as $key => $current) {
    $html4co .= '<tr>
        ...
        <td>' . $row['roll_no']. '</td>
		<td>' . $row['name']. '</td>
		<td>' . ($qz1max>0?($row['quiz1']*$qz1co/$qz1max):"") . '</td>
		<td>' . ($qz2max>0?($row['quiz2']*$qz2co/$qz2max):"") . '</td>
		<td>' . ($qz3max>0?($row['quiz3']*$qz3co/$qz3max):"") . '</td>
		<td>' . ($qz4max>0?($row['quiz4']*$qz4co/$qz4max):"") . '</td>
		<td>' . ($qz5max>0?($row['quiz5']*$qz5co/$qz5max):"") . '</td>
		<td>' . ($asg1max>0?($row['assign1']*$asg1co/$asg1max):"") . '</td>
		<td>' . ($asg2max>0?($row['assign2']*$asg2co/$asg2max):"") . '</td>
		<td>' . ($asg3max>0?($row['assign3']*$asg3co/$asg3max):"") . '</td>
		<td>' . ($asg4max>0?($row['assign4']*$asg4co/$asg4max):"") . '</td>
		<td>' . ($camax>0?($row['ca']*$caco/$camax):"") . '</td>
    </tr>';
...
//foreach($your_data_array as $key => $current) {
    $html5 .= '<tr>
        <td>' . $i . '</td>
        <td>' . $row['roll_no']. '</td>
		<td>' . ($mq1max>0?($row['mq1']*$mq1co/$mq1max):"") . '</td>
		<td>' . ($mq2max>0?($row['mq2']*$mq2co/$mq2max):""). '</td>
		<td>' . ($mq3max>0?($row['mq3']*$mq3co/$mq3max):""). '</td>
		<td>' . ($mq4max>0?($row['mq4']*$mq4co/$mq4max):""). '</td>
		<td>' . ($mq5max>0?($row['mq5']*$mq5co/$mq5max):""). '</td>
		<td>' . ($mq6max>0?($row['mq6']*$mq6co/$mq6max):""). '</td>
		<td>' . ($mq7max>0?($row['mq7']*$mq7co/$mq7max):""). '</td>
		<td>' . ($mq8max>0?($row['mq8']*$mq8co/$mq8max):""). '</td>
		<td>' . ($mq9max>0?($row['mq9']*$mq9co/$mq9max):""). '</td>
		<td>' . ($mq10max>0?($row['mq10']*$mq10co/$mq10max):""). '</td>
		<td>' . ($mq11max>0?($row['mq11']*$mq11co/$mq11max):""). '</td>
		<td>' . ($mq12max>0?($row['mq12']*$mq12co/$mq12max):""). '</td>
		<td>' . ($mq13max>0?($row['mq13']*$mq13co/$mq13max):""). '</td>
		<td>' . ($mq14max>0?($row['mq14']*$mq14co/$mq14max):""). '</td>
		<td>' . ($mq15max>0?($row['mq15']*$mq15co/$mq15max):""). '</td>
		<td>' . ($mq16max>0?($row['mq16']*$mq16co/$mq16max):""). '</td>
		<td>' . ($mq17max>0?($row['mq17']*$mq17co/$mq17max):""). '</td>
		<td>' . ($mq18max>0?($row['mq18']*$mq18co/$mq18max):""). '</td>
		<td>' . ($mq19max>0?($row['mq19']*$mq19co/$mq19max):""). '</td>
		<td>' . ($mq20max>0?($row['mq20']*$mq20co/$mq20max):""). '</td>
    </tr>';
endforeach;
...
<table width="92%" border="1">
            ...
            <tr style="background:lightblue">
                <th colspan="4" class="header">Scale</th>
...
//foreach($your_data_array as $key => $current) {
    $html5 .= '<tr>
        <td>' . $i . '</td>
        <td>' . $row['roll_no']. '</td>
		<td>' . ($eq1max>0?($row['eq1']*$eq1co/$eq1max):""). '</td>
		<td>' . ($eq2max>0?($row['eq2']*$eq2co/$eq2max):""). '</td>
		<td>' . ($eq3max>0?($row['eq3']*$eq3co/$eq3max):""). '</td>
		<td>' . ($eq4max>0?($row['eq4']*$eq4co/$eq4max):""). '</td>
		<td>' . ($eq5max>0?($row['eq5']*$eq5co/$eq5max):""). '</td>
		<td>' . ($eq6max>0?($row['eq6']*$eq6co/$eq6max):""). '</td>
		<td>' . ($eq7max>0?($row['eq7']*$eq7co/$eq7max):""). '</td>
		<td>' . ($eq8max>0?($row['eq8']*$eq8co/$eq8max):""). '</td>
		<td>' . ($eq9max>0?($row['eq9']*$eq9co/$eq9max):""). '</td>
		<td>' . ($eq10max>0?($row['eq10']*$eq10co/$eq10max):""). '</td>
		<td>' . ($eq11max>0?($row['eq11']*$eq11co/$eq11max):""). '</td>
		<td>' . ($eq12max>0?($row['eq12']*$eq12co/$eq12max):""). '</td>
		<td>' . ($eq13max>0?($row['eq13']*$eq13co/$eq13max):""). '</td>
		<td>' . ($eq14max>0?($row['eq14']*$eq14co/$eq14max):""). '</td>
		<td>' . ($eq15max>0?($row['eq15']*$eq15co/$eq15max):""). '</td>
		<td>' . ($eq16max>0?($row['eq16']*$eq16co/$eq16max):""). '</td>
		<td>' . ($eq17max>0?($row['eq17']*$eq17co/$eq17max):""). '</td>
		<td>' . ($eq18max>0?($row['eq18']*$eq18co/$eq18max):""). '</td>
		<td>' . ($eq19max>0?($row['eq19']*$eq19co/$eq19max):""). '</td>
		<td>' . ($eq20max>0?($row['eq20']*$eq20co/$eq20max):""). '</td>
    </tr>';
endforeach;
...
$html_attain='<div class="col-sm-12 table" style=" border-radius: 5px; background: #73AD21; padding: 20px;">
      

    <table class="table table-striped table-bordered table-condensed">
        <tr  style="background-color:#f07205">
 ...
 $html_attain.='<tr>
                ...
                <td bgcolor="#73AD21" align="center" colspan=3;><b>Total COs</b></td>
				<td bgcolor="green"><?php echo $co1_comp_total?></td>
				<td bgcolor="green"><?php echo $co2_comp_total?></td>
				<td bgcolor="green"><?php echo $co3_comp_total?></td>
				<td bgcolor="green"><?php echo $co4_comp_total?></td>
				<td bgcolor="green"><?php echo $co5_comp_total?></td>
				<td bgcolor="green"><?php echo $co6_comp_total?></td>
			</tr>';
...
$html_attain.='<tr>
				...
				<td><?php echo $co1_comp_total1?></td>
				<td><?php echo $co2_comp_total2?></td>
				<td><?php echo $co3_comp_total3?></td>
				<td><?php echo $co4_comp_total4?></td>
				<td><?php echo $co5_comp_total5?></td>
				<td><?php echo $co6_comp_total6?></td>
				
			</tr>';
 }
   $co1_student_perc=($co1_per/$i)*100;
   $co2_student_perc=($co2_per/$i)*100;
   $co3_student_perc=($co3_per/$i)*100;
   $co4_student_perc=($co4_per/$i)*100;
   $co5_student_perc=($co5_per/$i)*100;
   $co6_student_perc=($co6_per/$i)*100;
 } 
...
$html_attain.='</tbody>
	...
	<tr>
	<td><b><?php echo "Student having marks greater than ".$percentage ?></b></td>
				<td><?php echo $no_co1?></td>
				<td><?php echo $no_co2?></td>
				<td><?php echo $no_co3?></td>
				<td><?php echo $no_co4?></td>
				<td><?php echo $no_co5?></td>
				<td><?php echo $no_co6?></td>
	</tr>';
...
$html_attain.='<tr>
	<td><b>Attainment Level</br>( 1 --> 50% student have ><?php echo $percentage?>% marks)<br>( 2--> 60% student have ><?php echo $percentage?>% marks)</br>( 3--> 70% or more student have ><?php echo $percentage?>% marks)</b></td>
	<td><?php echo $attain_level1 ?></td>
	<td><?php echo $attain_level2 ?></td>
	<td><?php echo $attain_level3 ?></td>
	<td><?php echo $attain_level4 ?></td>
	<td><?php echo $attain_level5 ?></td>
	<td><?php echo $attain_level6 ?></td>
 ...
 $html_attain.='<td>
			...
			<?php echo $po11*$attain_level1 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po12*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po13*$attain_level1 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po14*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po15*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po16*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po17*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po18*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po19*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po110*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po111*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po112*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo11*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo12*$attain_level1 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo13*$attain_level1 ?>
			</div>
</td>
      ...
      <tr>
		...
		$html_attain.='<td>
			...
			<div class="form-group">
			<?php echo $po21*$attain_level2 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po22*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po23*$attain_level2 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po24*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po25*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po26*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po27*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po28*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po29*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po210*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po211*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po212*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo21*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo22*$attain_level2 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo23*$attain_level2 ?>
			</div>
</td>
		</tr>
	...
	$html_attain.='<td>
			...
			<div class="form-group">';
			 echo $po31*$attain_level3 ;
	$html_attain.='	</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po32*$attain_level3;
	$html_attain.='	</div>
</td>
			<td>
			<div class="form-group">';
			 echo $po33*$attain_level3 ;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po34*$attain_level3 ;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po35*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po36*$attain_level3;
$html_attain.='</div>
</td>
			<td>
			<div class="form-group">';
			 echo $po37*$attain_level3 ;
$html_attain.='</div>
</td>
			<td>
			<div class="form-group">';
			 echo $po38*$attain_level3;
$html_attain.='	</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po39*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			 echo $po310*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			echo $po311*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			echo $po312*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			echo $peo31*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			echo $peo32*$attain_level3;
$html_attain.='</div>
			</td>
			<td>
			<div class="form-group">';
			echo $peo33*$attain_level3;
$html_attain.='</div>
			</td>
		</tr>
     ...
     <tr>
		...
		?>
			...
			<div class="form-group">
			<?php echo $po41*$attain_level4 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po42*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po43*$attain_level4 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po44*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po45*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po46*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po47*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po48*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po49*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po410*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po411*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po412*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo41*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo42*$attain_level4 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo43*$attain_level4 ?>
			</div>
</td>
		</tr>
	<!------------- co5 ------------->
      <tr>
		...
		?>
			...
			<div class="form-group">
			<?php echo $po51*$attain_level5 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po52*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po53*$attain_level5 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po54*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po55*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po56*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po57*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po58*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po59*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po510*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po511*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po512*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo51*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo52*$attain_level5 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo53*$attain_level5 ?>
			</div>
</td>
		</tr>
...
<!------------- co6 ------------->
      <tr>
		...
		?>
			...
			<div class="form-group">
			<?php echo $po61*$attain_level6 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po62*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po63*$attain_level6 ?>
			</div>
			</td>
			<td>
			<div class="form-group">
			<?php echo $po64*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po65*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po66*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po67*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po68*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po69*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po610*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po611*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $po612*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo61*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo62*$attain_level6 ?>
			</div>
</td>
			<td>
			<div class="form-group">
			<?php echo $peo63*$attain_level6 ?>
			</div>
</td>
		</tr>
        ...
        <div class="form-group">
			...
			$po1= ($po11*$attain_level1+$po21*$attain_level2+$po31*$attain_level3+$po41*$attain_level4+$po51*$attain_level5+$po61*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po1;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po2=0;	
				...
				$po2= ($po12*$attain_level1+$po22*$attain_level2+$po32*$attain_level3+$po42*$attain_level4+$po52*$attain_level5+$po62*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po2;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po3=0;	
				...
				$po3= ($po13*$attain_level1+$po23*$attain_level2+$po33*$attain_level3+$po43*$attain_level4+$po53*$attain_level5+$po63*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po3;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po4=0;	
				...
				$po4= ($po14*$attain_level1+$po24*$attain_level2+$po34*$attain_level3+$po44*$attain_level4+$po54*$attain_level5+$po64*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po4;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po5= ($po15*$attain_level1+$po25*$attain_level2+$po35*$attain_level3+$po45*$attain_level4+$po55*$attain_level5+$po65*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po5
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po6=0;	
				...
				$po6= ($po16*$attain_level1+$po26*$attain_level2+$po36*$attain_level3+$po46*$attain_level4+$po56*$attain_level5+$po66*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po6;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po7=0;	
				...
				$po7= ($po17*$attain_level1+$po27*$attain_level2+$po37*$attain_level3+$po47*$attain_level4+$po57*$attain_level5+$po67*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po7;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po8=0;	
				...
				$po8= ($po18*$attain_level1+$po28*$attain_level2+$po38*$attain_level3+$po48*$attain_level4+$po58*$attain_level5+$po68*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}echo $po8;
			?>
			</div>
		</td>
        ...
        <div class="form-group">
			...
			$po9=0;	
				...
				$po9= ($po19*$attain_level1+$po29*$attain_level2+$po39*$attain_level3+$po49*$attain_level4+$po59*$attain_level5+$po69*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po9;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po10= ($po110*$attain_level1+$po210*$attain_level2+$po310*$attain_level3+$po410*$attain_level4+$po510*$attain_level5+$po610*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po10;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po11=0;	
				...
				$po11= ($po111*$attain_level1+$po211*$attain_level2+$po311*$attain_level3+$po411*$attain_level4+$po511*$attain_level5+$po611*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po11;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$po12=0;	
				...
				$po12= ($po112*$attain_level1+$po212*$attain_level2+$po312*$attain_level3+$po412*$attain_level4+$po512*$attain_level5+$po612*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $po12;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$peo1=0;	
				...
				$peo1= ($peo11*$attain_level1+$peo21*$attain_level2+$peo31*$attain_level3+$peo41*$attain_level4+$peo51*$attain_level5+$peo61*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $peo1;
			?>
			</div>
		...
		<td>
			...
			$peo2=0;	
				...
				$peo2= ($po12*$attain_level1+$peo22*$attain_level2+$peo32*$attain_level3+$peo42*$attain_level4+$peo52*$attain_level5+$peo62*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $peo2;
			?>
			</div>
        ...
        <div class="form-group">
			...
			$peo3= ($peo13*$attain_level1+$peo23*$attain_level2+$peo33*$attain_level3+$peo43*$attain_level4+$peo53*$attain_level5+$peo63*$attain_level6)/($attain_level1+$attain_level2+$attain_level3+$attain_level4+$attain_level5+$attain_level6) ;
			}
			echo $peo3;
			?>
			</div>
