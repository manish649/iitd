...
$html = '<div class="container" >
	...
	<div align="left">
	<table border="1">
	<tr><td rowspan="4"><b>Mr./Ms.'.$participant_name.'<b></td><td>SI. No.................</td></tr>
...
// include('pdf.php');
 ...
 $mail->Username = 'manishverma649@gmail.com';     //Sets SMTP username
 $mail->Password = 'nirmal64489';     //Sets SMTP password
 ...
 $mail->AddAddress('manish.verma1@sharda.ac.in', 'Name');  //Adds a "To" address
 $mail->WordWrap = 50;       //Sets word wrapping on the body of the message to a given number of characters
 $mail->IsHTML(true);       //Sets message type to HTML    
 $mail->AddAttachment($file_name);         //Adds an attachment from a path on the filesystem
 $mail->Subject = 'Fee Receipt';   //Sets the Subject of the message
 $mail->Body = 'Please Find Student Fee Receipt in attach PDF File.';    //An HTML or plain text message body
